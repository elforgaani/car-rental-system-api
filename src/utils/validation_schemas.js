...
export const createRentalRequestBodyValidationSchema = yup.object({
    rentalDate: yup.string().datetime().required(),
    returnDate: yup.string().datetime().required(),
    carId: yup.string().required().matches(/^[0-9A-Fa-f]+$/).min(24).max(24),
})